...
const Footer = () => {
  return (
    <>
      <Box id='bgMove' as='footer' py="20px" px={{ base: '40px', lg: '8%' }} borderBlock="1px" borderColor="#d4d4d4" bgPosition='center' bg='url(/assets/footer2.jpeg)' bgRepeat='repeat' bgSize='contain'>
        <Flex maxW={{ lg: '1446px', base: '100%' }} mx='auto' h={{lg:'400px', base:'max-content'}} py='2em' align='flex-start' justify="space-between" mt='20px' flexDir="column">
          ...
          <Box display="flex" flexWrap="wrap">
            <Flex w={{ lg: '35%', base: '100%' }} flexDir='column' justify='start' fontSize='.8rem'>
              <Text fontSize={{lg:'18px', base:'16px'}} pe='1rem'>
