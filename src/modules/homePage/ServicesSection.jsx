...
const ServicesSection = () => {
  return (
    <Box as='section' w="100%" px={{base:'40px', lg:'8%'}} py="24px">
      <Text textAlign="center" color="#244395" fontSize="2.5rem">Services</Text>
      <Text textAlign="center" color="#33333" fontSize="1.6rem">Select a service to see what we offer</Text>
